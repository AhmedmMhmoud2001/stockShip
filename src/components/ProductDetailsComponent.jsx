          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <Link
                ...
                className="block w-full rounded-md bg-blue-900 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
              >
                عرض قائمة البضائع
              </Link>
              ...
              {/* Company card */}
              <Link to={ROUTES.COMPANY_PROFILE}>
