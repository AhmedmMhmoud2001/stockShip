...
export default function CompanyAdsComponent() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-white  mt-25">
      <div className="w-full px-4 sm:px-8 md:px-12 lg:px-24 pt-30">
        ...
        {/* Offers */}
        <div className="mt-4 text-lg font-bold text-slate-900">العروض</div>
              ...
              <div className="flex gap-3">
                ...
                <div className="relative h-30 w-30 sm:h-30 sm:w-30 overflow-hidden rounded-md bg-slate-100 ring-1 ring-slate-200 shrink-0">
                  <img
                    ...
                    className="h-full w-full object-cover"
                  />
                  <div className="absolute top-1 left-1 rounded bg-white/90 px-1 py-0.5 text-[8px] font-bold text-red-600">
                    FOR SALE
                  </div>
                </div>
        ...
        >
          {[
            ["54364#", "اسمه التجاري"],
            ["LC, T/T, D/P, PayPal, Western Union", "الأنشطة و التخصصات"],
            ["5.0", "شروط الدفع:"],
            ["هواتف والإلكترونيات","شروط الشحن:"],
            ["هواتف والإلكترونيات","متوسط الوقت الرصاص:"],
          ].map(([val, key], i, arr) => (
            <div
              key={i}
            ...
            >
              {/* Value (left) */}
              <div className="px-4 py-3 text-sm text-slate-700" dir="rtl">
                {key === "تقييم الشركة" ? (
              ...
              {/* Key (right) */}
              <div
                className="px-4 py-3 text-sm font-semibold bg-slate-50 border-l border-slate-200 text-slate-700"
                dir="rtl"
              >
                {key}
              </div>
